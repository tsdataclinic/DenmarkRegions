...
from utils import get_poly_with_interpolated_pop, get_buffered_weights

results_dir = '/data/results/polygons_compact_rook_interpolated/'
if not os.path.exists(results_dir):
    os.makedirs(results_dir)
    os.makedirs(results_dir+'plots/')
    os.makedirs(results_dir+'geometries/')
else:
    print('WARNING!!: results directory exist, will replace existing results')
...
for m in municipalities:
    ...
    try:
        ...
        poly_w_pop = get_poly_with_interpolated_pop(poly, to_cluster)
